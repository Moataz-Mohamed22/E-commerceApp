...
import '../domain/repositories/repository/cart/cart_repository.dart' as _i901;
...
import '../features/ui/pages/home_screen/tabs/home_tab/manager/brandes/brandes_cubit.dart'
    as _i503;
import '../features/ui/pages/home_screen/tabs/home_tab/manager/category/category_cubit.dart'
    as _i450;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i901.CartRepository>(() => _i230.CartRepositoryImpl(
        cartRemoteDataSource: gh<_i129.CartRemoteDataSource>()));
    ...
    gh.factory<_i576.DeleteItemsInCartUseCase>(() =>
        _i576.DeleteItemsInCartUseCase(
            cartRepository: gh<_i901.CartRepository>()));
    gh.factory<_i283.GetItemsInCartUseCase>(() => _i283.GetItemsInCartUseCase(
        cartRepository: gh<_i901.CartRepository>()));
    ...
    gh.factory<_i450.CategoryCubit>(() =>
        _i450.CategoryCubit(useCase: gh<_i241.GetAllCategoriesUseCase>()));
    ...
    gh.factory<_i503.BrandsCubit>(
        () => _i503.BrandsCubit(useCase: gh<_i417.GetAllBrandsUseCase>()));
